...
hostBuilder.Services.AddTransient<ITypedClient>(x => x.GetRequiredService<TypedClient1>());
hostBuilder.Services.AddTransient<ITypedClient>(x => x.GetRequiredService<TypedClient2>());
